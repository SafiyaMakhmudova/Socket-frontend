...
const { yes,no, iconBtn } = useClient()
...
<template>
  <div>
    <i v-if="no" class='text-6xl text-authBgE  flex float-right pr-8 bg-fixed items-end bx bxs-chat mb-4' @click="iconBtn"></i>
</div>
